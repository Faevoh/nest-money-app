...
exports.ComplianceChanges1688027941414 = void 0;
class ComplianceChanges1688027941414 {
    constructor() {
        this.name = 'ComplianceChanges1688027941414';
    }
    async up(queryRunner) {
        ...
        await queryRunner.query(`ALTER TABLE \`compliances\` ADD \`account\` varchar(255) NOT NULL`);
        await queryRunner.query(`ALTER TABLE \`compliances\` ADD UNIQUE INDEX \`IDX_3618f887e34533baa03da76b80\` (\`account\`)`);
    ...
    async down(queryRunner) {
        ...
        await queryRunner.query(`ALTER TABLE \`compliances\` DROP INDEX \`IDX_3618f887e34533baa03da76b80\``);
        await queryRunner.query(`ALTER TABLE \`compliances\` DROP COLUMN \`account\``);
...
exports.ComplianceChanges1688027941414 = ComplianceChanges1688027941414;
//# sourceMappingURL=1688027941414-ComplianceChanges.js.map