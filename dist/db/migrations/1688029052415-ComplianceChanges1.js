...
exports.ComplianceChanges11688029052415 = void 0;
class ComplianceChanges11688029052415 {
    constructor() {
        this.name = 'ComplianceChanges11688029052415';
    }
    async up(queryRunner) {
        ...
        await queryRunner.query(`DROP INDEX \`IDX_3618f887e34533baa03da76b80\` ON \`compliances\``);
    ...
    async down(queryRunner) {
        ...
        await queryRunner.query(`CREATE UNIQUE INDEX \`IDX_3618f887e34533baa03da76b80\` ON \`compliances\` (\`account\`)`);
...
exports.ComplianceChanges11688029052415 = ComplianceChanges11688029052415;
//# sourceMappingURL=1688029052415-ComplianceChanges1.js.map