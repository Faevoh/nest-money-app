...
export class UsersChanges1688084151461 implements MigrationInterface {
    name = 'UsersChanges1688084151461'
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`users\` ADD \`accountName\` varchar(255) NOT NULL`);
        await queryRunner.query(`ALTER TABLE \`users\` DROP COLUMN \`accountNumber\``);
        await queryRunner.query(`ALTER TABLE \`users\` ADD \`accountNumber\` varchar(255) NOT NULL`);
        await queryRunner.query(`ALTER TABLE \`users\` DROP COLUMN \`accountType\``);
        await queryRunner.query(`ALTER TABLE \`users\` ADD \`accountType\` varchar(255) NOT NULL`);
